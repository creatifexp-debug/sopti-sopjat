      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-wrap gap-3 mb-10 overflow-x-auto pb-2">
          ...
          <button
            ...
            className={`px-4 py-2 rounded-full border text-sm whitespace-nowrap ${activeCategory === null
              ? "bg-white text-black"
          ...
          {categories.map((cat: any) => {
            ...
            return (
              ...
              <button
                ...
                className={`px-4 py-2 rounded-full border text-sm whitespace-nowrap ${activeCategory === name
                  ? "bg-white text-black"
                  : "border-zinc-700 text-gray-300"
                  }`}
              >
